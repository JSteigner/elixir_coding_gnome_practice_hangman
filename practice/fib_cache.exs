defmodule Cache do
  ...
  @moduledoc """
  We implement a simple key/value cache. State is stored in an Agent, the form of a map.

  The function 'lookup' tries to look the value up in the cache,
  and then calls 'complete_if_not_found'. This takes two forms. If there was
  no value in the cache, it calls the function passed in by the client to supply it,
